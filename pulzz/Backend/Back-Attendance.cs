...
namespace pulzz.Backend
{
    public partial class Back_Attendance : Form
    {
        ...
        private void AdninForm_Load_1(object sender, EventArgs e)
        {
        ...
        private void txt1_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            try
            {
                conn.Open();
        ...
        private void AbsentBtn_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBox.Show("Are You Sure You Want to Add this Absense?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    conn.Open();
